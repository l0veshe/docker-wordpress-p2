...
<!--[if (gte IE 9)|(gt IEMobile 7)|!(IEMobile)|!(IE)]><!--><html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
	...
	<head>
		...
		<link rel="shortcut icon" href="<?php echo  bloginfo('siteurl'); ?>//favicon.ico">
						...
						<div class="container-fluid nav-container">
							<nav role="navigation">
								<!-- <a class="brand" id="logo" title="<?php echo get_bloginfo('description'); ?>" href="<?php echo home_url(); ?>"><?php bloginfo('name'); ?></a> -->
								 <a class="brand" id="logo" title="<?php echo get_bloginfo('description'); ?>" href="<?php echo home_url(); ?>"><img src="<?php echo  bloginfo('siteurl'); ?>/gizur_logo.png" height="42" width="42"></a> 
